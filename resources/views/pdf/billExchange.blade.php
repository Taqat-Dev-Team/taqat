...
<head>
    ...
    <style>
        body {
            font-family: 'Circo', sans-serif; /* Apply Circo font */
            direction: rtl;
...
.signatures .signature {
    text-align: center;
    font-size: 16px;
    width: 45%; /* لتحديد عرض مناسب لكل قسم */
    position: relative;
}
...
<body>
    <div class="receipt-container">
        <div class="header">
            <div class="logo">
                <img alt="Logo" src="https://taqat-gaza.com/uploads/images/settings//I99I9XyqKRi8w5sW.png" class="h-120px" style="width: 180px; height: auto;"/>
            </div>
        </div>
