    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="card card-custom gutter-b">
                    ...
                    <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#kt_apps_contacts_view_tab_1">
                                ...
                                <span class="nav-text">{{ __('label.project_details') }}</span>
                            </a>
                        </li>
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" href="#kt_apps_contacts_view_tab_2">
                                ...
                                <span class="nav-text">{{ __('label.received_required') }}</span>
                            </a>
                        </li>
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" href="#kt_apps_contacts_view_tab_3">
                                ...
                                <span class="nav-text">{{ __('label.offers') }}</span>
                            </a>
                        </li>
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" href="#kt_apps_contacts_view_tab_4">
                                ...
                                <span class="nav-text">{{ __('label.project_impelmention') }}</span>
                            </a>
                        </li>
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" href="#kt_apps_contacts_view_tab_5">
                                ...
                                <span class="nav-text">{{ __('label.review') }}</span>
                            </a>
                        </li>
                        @if ($project->status != 1)
                            <li class="nav-item mr-3">
                                <a class="nav-link" data-toggle="tab" href="#kt_apps_contacts_view_tab_6">
                                    <span class="nav-icon mr-2">
                                        <svg width="16" height="16" fill="currentColor" class="bi bi-gem"
                                            viewBox="0 0 16 16">
                                            <path
                                                d="M7.934.5a.5.5 0 0 1 .132 0l5.303 2.93a.5.5 0 0 1 .226.274L15 6.387v5.226a.5.5 0 0 1-.25.433l-6.697 4.357a.5.5 0 0 1-.517 0l-6.698-4.357A.5.5 0 0 1 0 11.613V6.387l1.337-2.684a.5.5 0 0 1 .226-.274L7.934.5zM7.5 1.264 2.317 4.5 1.5 6.387 7.5 10.35 13.5 6.387 12.683 4.5 7.5 1.264zM2.156 6.117 7.5 8.728l5.344-2.611L12.75 6H3.25L2.156 6.117z" />
                                        </svg>


                                    </span>
                                    <span class="nav-text">{{ __('label.mystone') }}</span>
                                </a>
                            </li>
                        @endif
                    </ul>
                        ...
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title=""
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi navi-hover">
                                    ...
                                    <li class="navi-item">
                                        <a href="https://taqat-gaza.com/ar/project/{{ $project->slug }}"
                                            class="navi-link">
                                            <span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="" class="navi-link  delete" name_delete="{{ $project->title }}"
                                            data-delete_id="{{ $project->id }}">
                                            <span class="navi-icon">
                            ...
                            <div class="container">
                                ...
                                <span class="font-weight-bolder font-size-h5 pt-1">
                                    ...
                                    <span class="font-weight-bolder font-size-h5 pt-1">
                                        ...
                                        <span
                                            class="font-weight-bolder mb-4">{{ __('label.project_impelmention') }}</span>
                                        <span class="font-weight-bolder font-size-h5 pt-1">
                                            <span
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="my-lg-0 my-1">
                                                            @if ($project->status == 1)
                                                                <a href="#"
                                                                    class="btn btn-sm btn-light-primary font-weight-bolder text-uppercase mr-2 accept_offer"
                                                                    data-offer_id="{{ $value->id }}">{{ __('label.accept_offer') }}</a>

                                                                <a href="#"
                                                                    class="btn btn-sm btn-danger font-weight-bolder text-uppercase zoom_interview "
                                                            ...
                                                            @else
                                                                @if ($project->user_id == $value->user_id)
                                                                    <a href="#"
                                                                        class="btn btn-sm btn-light-success font-weight-bolder text-uppercase mr-2">{{ __('label.job_impelmention') }}</a>
                                                                @else
                                                                    <a href="#"
                                                                        class="btn btn-sm btn-light-danger font-weight-bolder text-uppercase mr-2">{{ __('label.excluded') }}</a>
                                                                @endif
                                                            @endif
                                                            <a href="#"
                                                                class="btn btn-sm btn-primary font-weight-bolder text-uppercase chat_room"
                                                                data-user_id="{{ $value->user_id }}"
                                                                data-project_id="{{ $project->id }}"
                                                                data-company_id="{{ auth('company')->id() }}"
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span
                                                            class="font-weight-bolder font-size-sm">{{ __('label.min_income') }}</span>
                                                        <span class="font-weight-bolder font-size-h5">
                                                            <span
                                                ...
                                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span
                                                            class="font-weight-bolder font-size-sm">{{ __('label.max_income') }}</span>
                                                        <span class="font-weight-bolder font-size-h5">
                                                            <span
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="mr-3">
                                                            <!--begin::Name-->
                                                            <a href="https://taqat-gaza.com/talents/{{ $project->users?$project->users->slug:'' }}"
                                                                target="__blank"
                                                        ...
                                                        <div class="my-lg-0 my-1">
                                                            ...
                                                            <a href="#"
                                                                class="btn btn-sm btn-light-success font-weight-bolder text-uppercase mr-2">{{ __('label.project_impelmention') }}
                                                            </a>
                                                            ...
                                                            <a href="#" <a href="#"
                                                                ...
                                                                data-project_id="{{ $project->id }}" data-toggle="modal"
                                                    ...
                                                    <div
                                                        class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
                                                        {{ __('label.cost') }} :{{ $project->cost }} $</div>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span
                                                            class="font-weight-bolder font-size-sm">{{ __('label.projects_count') }}
                                                        </span>
                                                        <span class="font-weight-bolder font-size-h5">
                                                            <span
                                ...
                                <form id="form" class="my-form" method="POST" action="#">
                                    ...
                                    <div class="rating-container">
                                        ...
                                        <div class="rating-item">
                                            <label>{{ __('label.professional_dealing') }}</label>
                                            <div class="stars" data-rating-type="professional_dealing">
                                                @for ($i = 1; $i <= 5; $i++)
                                                    <span
                                                        ...
                                                        data-value="{{ $i }}">&#9733;</span>
                                                @endfor
                                                <input type="hidden" name="professional_dealing"
                                                    id="professional_dealing"
                                        ...
                                        <div class="rating-item">
                                            <label>{{ __('label.communicate_professionally') }}</label>
                                        ...
                                        <div class="rating-item">
                                            <label>{{ __('label.quality_of_delivered_work') }}</label>
                                        ...
                                        <div class="rating-item">
                                            <label>{{ __('label.experience_in_the_project_field') }}</label>
                                        ...
                                        <div class="rating-item">
                                            <label>{{ __('label.delivery_on_time') }}</label>
                                        ...
                                        <div class="rating-item">
                                            <label>{{ __('label.deal_with_it_again') }}</label>
                                        ...
                                        <div class="rating-item">
                                            ...
                                            <textarea class="form-control" name="message" id="message">{{ $ratings->message ?? '' }}</textarea>
                                        </div>

                                    </div>
                                    <button @if ($project->status != 3) disabled @endif type="submit"
                                        class="rating-form" id="rating-form">{{ __('label.submit') }}</button>

                                    @if ($project->status != 3)
                                        <h5 style="color:red">
                                            {{ __('label.the_project_implementer_can_be_evaluated_at_the_project_delivery_stage_only') }}
                                        </h5>
                                    @endif
                                </form>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <a href="#" style="float: left;"
                                        class="btn btn-sm btn-primary font-weight-bold text-uppercase" data-toggle="modal"
                                        data-target="#mystoneModal" id="mystone">

                                        {{ __('label.add_new_payments') }}
                                    </a>
                                </div>
                            </div>
                            <hr>
                            <div class="col-12 col-lg-12">
                                ...
                                <div class="table-responsive mt-3">
                                    <table class="table table-head-custom table-vertical-center"
                                        ...
                                        @foreach ($project->myStones as $value)
                                            <tr>
                                                <td>{{ $value->title }}</td>
                                                <td>{{ $value->amount }}</td>
                                                <td>{{ $value->date }}</td>
                                                ...
                                                @if ($value->status == 1)
                                                    <td><a target="__blank" class="btn btn-primary"
                                                            href="{{ route('companies.mystone.paymentMystone', ['my_stone_id' => $value->id]) }}">{{ __('label.payment_now') }}</a>
                                                    </td>
                                                @endif
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="chatForm" class="chat" name="chat" method="POST" action="#">
                                    ...
                                    <input value="" name="project_id" type="hidden" id="chat_project_id">
                                    <input value="" name="user_id" type="hidden" id="chat_user_id">
                            ...
                            <div class="modal-footer">
                                <div class="row">
                                    <div class="col col-lg-6">
                                        <button type="submit"
                                            class="btn btn-primary m-1 submit_chat">{{ __('label.submit') }}</button>
                ...
                <div class="modal fade" id="mystoneModal" tabindex="-1" role="dialog"
                    aria-labelledby="mystoneModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <label class="modal-title"
                                    id="mystoneModalLabel">{{ __('label.mystone_payment') }}</label>
                                {{-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button> --}}
                            </div>
                            <div class="modal-body">
                                <form id="mystone-form" name="mystone-form" method="POST">
                                    @csrf
                                    <div class="form-row">
                                        <!-- First row of inputs -->
                                        <div class="form-group col-md-6">
                                            <label for="modal-title">{{ __('label.title') }}</label>
                                            <input type="text" class="form-control" id="modal-title" name="title">
                                            <input type="hidden" value="{{ $project->id }}" name="project_id">

                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="modal-amount">{{ __('label.amount') }}</label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="modal-date">{{ __('label.date') }}</label>
                                            <div class="input-group date">
                                                <input type="text" class="form-control datepicker" id="modal-date"
                            ...
                            <div class="modal-footer row">
                                <div class="col-log-6">
                                    ...
                                    <button type="button" class="btn btn-primary m-1"
                                        id="save-button">{{ __('label.submit') }}</button>
                                </div>
                                <div class="col-log-6">
                                    <button type="button" class="btn btn-secondary"
                                        data-dismiss="modal">{{ __('label.cancel') }}</button>
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mystoneModalLabel"></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <p>{{ __('label.do_you_want_to_move_to_the_implementation_phase_of_the_project') }}
                                </p>
                            ...
                            <div class="modal-footer">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <button type="button" class="btn btn-primary m-1"
                                            id="confirmButton">{{ __('label.submit') }}</button>
                ...
                <div class="modal fade" id="zoomInterviewModal" tabindex="-1" aria-labelledby="zoomInterviewModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="zoomInterviewModalLabel">{{ __('label.interview') }}
                                </h5>
                            </div>
                            <div class="modal-body">
                                <form id="form-zoom" name="form-zoom" method="post">
                                    ...
                                    <input type="hidden" name="user_id" id="interview_user_id">
                                    <input type="hidden" name="project_id" id="interview_project_id">
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary meet_submit"><span
                                                class="hidden_class"><i class="fa fa-paper-plane"
            ...
            @section('scripts')
                @include('companies.projects.js.view')
            @endsection
