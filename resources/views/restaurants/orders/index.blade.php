...
@section('content')
    <div class="card card-custom">
        ...
        <div class="form-group row m-1">
            ...
            <div class="col-lg-4">
                ...
                <div class="input-group date">
                    <input type="text" class="form-control datepicker" value="" readonly="readonly" name="end_date"
            ...
            <div class="col-lg-4">
                ...
                <select id="status_cd_id" name="status_cd_id" class="form-control select2">
                    ...
                    <option value="0" @if($status=='new') selected @endif class="text-danger">جديد</option>
    ...
    @include('restaurants.orders.modal.edit')

    @include('restaurants.orders.modal.view')

    @include('Shared.delete')
@endsection

@section('scripts')
    @include('restaurants.orders.js.js')
@endsection
