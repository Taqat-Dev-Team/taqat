...
<body id="kt_body"
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        @include('layouts.includes.restaurant_meun')
                        <!--end::Menu Nav-->
                    </div>
                    <!--end::Menu Container-->
                </div>
                        ...
                        <div class="topbar" style="align-items:center">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                    ...
                                    <span
                                        class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ auth('restaurant')->user()->name }}</span>
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                                        اهلا بك {{ auth('restaurant')->user()->name }}
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('{{ auth('restaurant')->user()->logo }}')">
                ...
                <div class="d-flex flex-column">
                    <a href="#"
                        class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ auth('restaurant')->user()->name }}</a>
                    ...
                    <div class="navi mt-2">
                        <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span
                                    class="navi-text text-muted text-hover-primary">{{ auth('restaurant')->user()->email }}</span>
                            </span>
                        </a>
        ...
        <audio id="orderSound" src="{{ asset('assets/mixkit-arabian-mystery-harp-notification-2489.wav') }}"></audio>
    ...
    <script>
        ...
        channel.bind('new-order', function(data) {
            ...
            document.getElementById('orderSound').play().catch(function(e) {
                console.warn("لم يتم تشغيل الصوت تلقائيًا. يحتاج إلى تفاعل من المستخدم أولاً.");
            });
            ...
            toastr.options = {
                ...
                timeOut: "5000",
                onclick: function() {
                    // الانتقال إلى صفحة الطلب مثلاً:
                    window.location.href = `{{ route('restaurants.orders.index') }}`;
                }
            };
            $('.data-table').DataTable().ajax.reload();
            $('.order-table').DataTable().ajax.reload();

            toastr.success(`طلب جديد من: ${data.order.users.name}`, 'طلب جديد');
