                            ...
                            <div class="d-flex align-items-center justify-content-between mb-5">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-circle symbol-50 mr-3">
                                        <img alt="Pic" src="{{ $value->company->getPhoto() }}" />
                                    </div>
                                    <div class="d-flex flex-column">
                                        <a href="{{route('front.chats.view',$value->key) }}"
                                            class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">{{ $value->company->name }}</a>
                                        <span
                                            class="text-muted font-weight-bold font-size-sm">

                                            {{-- {{ $value->projects?$value->projects->title:'-' }} --}}
                                            @if($value->projects)
...
@section('scripts')
    <script>
        ...
        $('.chat-send').on('click',function(e){
            ...
            $.ajax({
            url: '{{ route('front.chats.saveMessage') }}',
            type: 'POST',
            data: {
