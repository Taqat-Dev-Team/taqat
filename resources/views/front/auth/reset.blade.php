        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            ...
            <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <div  class="form-container active">
                    ...
                    <form class="form w-100"  name="reset_password" id="reset_password" method="post" action="{{route('password.update')}}">
                        @csrf
                        ...
                        <div class="fv-row mb-10">
                            <label class="form-label fs-6 fw-bolder text-dark">كلمة المرور</label>
                            <input class="form-control form-control-lg form-control-solid" required type="text" id="text" placeholder="*******" name="password" autocomplete="off"/>
                        </div>
                        <div class="fv-row mb-10">
                            <label class="form-label fs-6 fw-bolder text-dark">تاكيد كلمة المرور</label>
                            <input class="form-control form-control-lg form-control-solid" required type="text" id="text" placeholder="*******" name="password confirmation" autocomplete="off"/>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
...
<script>
    ...
    $(document).ready(function() {
        $('#reset_password').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('password.update') }}", // Ensure this route is correct
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    window.location.href = "{{route('login')}}"; // Adjust the redirection if needed
