    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap">
            <div class="card-title">
                <h1 class="card-label">تعديل الحركة المالية</h1>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <input type="number" name="amount" class="form-control" id="amount" value="{{$incomeMovement->amount}}"
                                   placeholder="">
...
@section('scripts')
@include('front.incomeMovements.js.edit')
@endsection
