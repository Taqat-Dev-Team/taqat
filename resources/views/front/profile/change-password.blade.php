    ...
    <div class="card card-custom">
        ...
        <div class="card-header py-3">
            <div class="card-title align-items-start flex-column">
                ...
                <span class="text-muted font-weight-bold font-size-sm mt-1">تغير كلمة المرور الحساب الشخصي</span>
            </div>
        ...
        <form id="form" class="form" action="" method="post">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">كلمة المرور الحالية:
                    ...
                    <div class="col-lg-9 col-xl-6">
                        ...
                        <div class="input-group input-group-lg input-group-solid">
                            <input class="form-control form-control-lg form-control-solid" placeholder="كلمة المرور الحالية" name="current_password" type="password"
                            />
                        </div>
                        @error('name')
                ...
                <!--begin::Form Group-->
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">كلمة المرور الجديدة
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">رقم الجوال
                        <span class="text-danger">*</span></label>
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
    ...
    <script>
        $('#form').validate({
            ...
            ,                submitHandler: function(form) {
                ...
                $.ajax({
                    url: '{{route('front.profile.changePasswordProfile')}}' ,
                    type: "POST",
                    data: data,
                    dataType: 'JSON',
                    contentType: false,
                    ...
                    success: function( response ) {
                        ...
                        if (response.status){
                            ...
                            setTimeout( function(){
                                    window.location.replace('{{route("front.profile.changePassword")}}')
                                }
                                ,
                                2000 );
                        }else{
