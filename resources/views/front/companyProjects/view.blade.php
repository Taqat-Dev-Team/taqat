...
@section('content')
                        ...
                        <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x" role="tablist">
                            ...
                            <li class="nav-item mr-3">
                                <a class="nav-link" data-toggle="tab" href="#kt_apps_contacts_view_tab_5">
                                    <span class="nav-icon mr-2">
                                        <span
                                            class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Cooking\Dishes.svg--><svg
                                ...
                                @if ($project->myOffer())
                                    <div class="form-group row">
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <input type="number" name="cost" readonly class="form-control"
                                                id="cost" value="{{ $project->myOffer()->cost }}" value=""
                                                placeholder="">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <input type="number" min="1" name="duration" readonly
                                                class="form-control" value="{{ $project->myOffer()->duration }}"
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <textarea class="form-control" name="description" readonly>{{ $project->myOffer()->description }}</textarea>
                                    </div>
                                @else
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 col-sm-12">
                                                ...
                                                <input type="number" min="1" name="duration"
                                                    class="form-control" id="duration" value="{{ old('duration') }}"
                                                    placeholder="">
                        ...
                        <div class="tab-pane" id="kt_apps_contacts_view_tab_6" role="tabpanel">
                            <div class="container">
                                ...
                                @if ($project->status == 3 && $project->user_id == auth()->id())
                                    ...
                                    <form id="review-form" name="review-form" class="review-form" method="POST"
                                        action="#">
                                        @csrf
                                        ...
                                        <input type="hidden" name="rating" id="rating"
                                            value="{{ $userRattings->rating ?? 0 }}">
                                        <label for="message">الرسالة :</label>
                                        <textarea name="message" id="message" class="form-control">{{ $userRattings ? $userRattings->message : '' }}</textarea>
                                        <hr>
                        ...
                        <div class="tab-pane" id="kt_apps_contacts_view_tab_7" role="tabpanel">
                            ...
                            <div class="col-12 col-lg-12">
                                ...
                                <div class="table-responsive mt-3">
                                    <table class="table table-head-custom table-vertical-center kt_advance_table_widget_1"
    ...
    <div class="modal fade" id="mystoneModal" tabindex="-1" role="dialog" aria-labelledby="mystoneModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title" id="mystoneModalLabel"> اضافة دفعة جديدة </label>
                    ...
                    <form id="mystone-form" name="mystone-form" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="modal-title">العنوان</label>
                                <input type="text" class="form-control" id="modal-title" name="title">
                                <input type="hidden" value="{{ $project->id }}" name="project_id">

                            </div>
                            <div class="form-group col-md-6">
                                <label for="modal-amount">قيمة المالية</label>
                                <input type="number" class="form-control" id="modal-amount" min="10"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group date">
                                    <input type="text" class="form-control datepicker" id="modal-date" name="date"
                                        readonly="readonly" />
...
@section('scripts')
@include('front.companyProjects.js.view')
@endsection
