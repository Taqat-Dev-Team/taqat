    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: auto; background-color: #ffffff;">
        ...
        <tr>
            <td style="padding: 20px; text-align: center;">
                <h4 style="color: #000000; line-height: 32px;"> {{$job->title}}</h4>
                <p>{{$job->description }}</p>
                <a  style="color: white;" href="https://taqat-gaza.com/ar/job/{{$job->slug}}" class="button">عرض تفاصيل الوظيفة</a>
            </td>
        </tr>
        <tr>
            <td style="padding: 20px; text-align: center;">
