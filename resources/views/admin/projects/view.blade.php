...
<div class="card card-custom">
    <div class="card-header flex-wrap">
        <div class="card-title">
            <h1 class="card-label">{{ __('label.show_project') }}</h1>
        </div>
                        ...
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi navi-hover">
                                    ...
                                    <li class="navi-item">
                                        <a href="https://taqat-gaza.com/ar/project/{{$project->users?$project->users->slug:''}}" class="navi-link">
                                            <span class="navi-icon">
                                    ...
                                    <li class="navi-item">
                                        <a href="" class="navi-link  delete" name_delete="{{$project->title}}" data-delete_id="{{$project->id}}">
                                            <span class="navi-icon">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div
                                                        class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
                                                        {{__('label.sallary')}} :{{ $value->cost }} $</div>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span class="font-weight-bolder font-size-sm">{{__('label.total_income')}}</span>
                                                ...
                                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span class="font-weight-bolder font-size-sm">{{__('label.min_income')}}</span>
                                                        <span class="font-weight-bolder font-size-h5">
                                                            <span
                                                ...
                                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span class="font-weight-bolder font-size-sm">{{__('label.max_income')}}</span>
                                                        <span class="font-weight-bolder font-size-h5">
                                                            <span
                                                ...
                                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                                    ...
                                                    <div class="d-flex flex-column text-dark-75">
                                                        <span class="font-weight-bolder font-size-sm">{{__('label.projects_count')}}</span>
                                                        <span class="font-weight-bolder font-size-h5">
                                                            <span
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="my-lg-0 my-1">
                                                            ...
                                                            <a href="#"
                                                                class="btn btn-sm btn-light-success font-weight-bolder text-uppercase mr-2">{{__('label.project_impelmention')}}</a>
                                                    ...
                                                    <div
                                                        class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
                                                        {{__('label.price')}} :{{ $project->cost }} $</div>
