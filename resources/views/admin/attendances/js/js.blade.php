...
<script>
    $(document).ready(function() {
        ...
        initializeFormValidation("#my-form", "{{ route('admin.attendances.attendances') }}");
        initializeFormValidation("#edit-form", "{{ route('admin.attendances.update') }}");
    });
    ...
    function initializeDataTable() {
        return $('.data-table').DataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('admin.attendances.getIndex') }}",
                type: 'GET',
                data: function(d) {
    ...
    function updateData(table) {
        ...
        $.ajax({
            url: '{{ route('admin.attendances.getData') }}',
            method: 'POST',
            data: {
                user_id: user_id,
