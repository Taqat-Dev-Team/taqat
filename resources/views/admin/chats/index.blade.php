                            ...
                            <div class="d-flex align-items-center justify-content-between mb-5">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('admin.chats.view', $value->key) }}"
                                        ...
                                        <span
                                            ...
                                            {{-- {{ $value->projects ? $value->projects->title : '-' }}</span> --}}
                                    </div>
                                </div>
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-left dropdown-menu-md">
                                    ...
                                    <ul class="navi navi-hover py-5">
                                        @if ($chat)
                                            ...
                                            <li class="navi-item">
                                                <a target="_blank"
                                                    href="https://taqat-gaza.com/ar/talents/{{ $chat->users->slug }} }}"
                                                    class="navi-link">
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-left dropdown-menu-md">
                                    ...
                                    <ul class="navi navi-hover py-5">
                                        @if ($chat)
                                            ...
                                            <li class="navi-item">
                                                <a href="https://taqat-gaza.com/ar/talents/{{ $chat->users?$chat->users->slug:'' }}"
                                                    class="navi-link">
                                                    <span class="navi-icon">
                                                        <i class="flaticon2-list-3"></i>
                                                    </span>
