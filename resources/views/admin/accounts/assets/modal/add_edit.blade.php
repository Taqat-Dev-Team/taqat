    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="kt_modal_add_editLabel">{{ __('label.add_new_asset') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="my-form" method="POST" name="my-form" action="{{route('admin.accounts.assets.store')}}">
                @csrf
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" class="form-control" id="add_edit_account_id" name="account_id" required>

                        <!-- حقل parent_id -->
                        <div class="form-group col-md-6">
                            <label for="parent_id">{{ __('label.parent') }}

                                <span class="error">*</span>

                            </label>
                            <select class="form-control" id="add_edit_parent_id" name="parent_id" style="width: 100%">
