...
<head>
    ...
    <link href="https://taqat-gaza.com/dashboard/assets/plugins/global/plugins.bundle.css" rel="stylesheet"
        type="text/css" />
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                ...
                <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <div class="form-container active">
                        <form class="form w-100" name="login-form" id="login-form" method="post"
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-lg form-control-solid" type="email"
                                    id="email" placeholder="{{ __('label.email') }}" name="email"
                                    autocomplete="off" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                <label
                                    class="form-label fw-bolder text-dark fs-6 mb-0">{{ __('label.password') }}</label>
                                <input placeholder="***********" class="form-control form-control-lg form-control-solid"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#login-form').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.login.post') }}", // Ensure this route is correct
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response) {
                       console.log(response.redirect);
                        ...
                        if (response && response.redirect) {
                            ...
                            window.location.href = "{{ route('admin.home') }}"; // fallback
                        }
                    },
                    error: function(xhr) {
