    ...
    <div class="card card-custom">
        ...
        <form id="form" class="form" action="" method="post">
            ...
            <div class="card-body">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid"
                                   value="{{auth('admin')->user()->email}}" name="email" placeholder=""/>
                        </div>
                        @error('email')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid"
                                   value="{{auth('admin')->user()->mobile}}" name="mobile" placeholder="رقم الجوال"/>
                        </div>
                        @error('mobile')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label"> USD
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="number" class="form-control form-control-lg form-control-solid"
                                   value="{{\App\Models\Setting::first()->ILS_USD}}" name="ILS_USD" placeholder="ILS"/>    ILS
                        </div>
                        @error('ILS_USD')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                $.ajax({
                    ...
                    success: function( response ) {
                        if (response.status){
                            ...
                            setTimeout( function(){
                                    window.location.replace('{{route("admin.profile.index")}}')
                                }
                                ,
                                2000 );
