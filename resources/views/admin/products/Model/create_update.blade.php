<div class="modal fade" id="kt_modal_add_edit" tabindex="-1" aria-labelledby="kt_modal_add_editLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="my-form" method="POST" name="my-form" action="{{ route('admin.products.store') }}">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="add_edit_price" class="form-label fw-bold">
                                {{ __('label.restaurant') }} <span class="text-danger">*</span>
                            </label>
                            <select class="form-control" id="add_edit_restaurant_id" name="restaurant_id"
                                style="width: 100%">
                                <option value="" selected disabled>{{ __('label.select_category') }}</option>
