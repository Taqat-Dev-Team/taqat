...
namespace App\Http\Controllers\Restaurants\Products;
...
class ProductController extends Controller
{
        public function index(Request $request)
    {
        ...
        $data['categories'] = ProductCategory::query()->active()->get();
        return view('restaurants.products.index', $data); // Load the view for DataTable
    }

    public function getIndex(Request $request)
    {
        $restaurant_id = $request->restaurant_id ?? false;
        ...
        return DataTables::of($query)
            ...
            ->addColumn('logo', fn($data) => view('restaurants.products.partials.coverImage', compact('data')))
            ->addColumn('is_active', fn($data) => view('restaurants.products.partials.active_toggle', compact('data')))
            ->addColumn('actions', fn($data) => view('restaurants.products.partials.actions', compact('data')))
    ...
    public function store(ProductRequest $request)
    {
        ...
        if ($request->logo) {
            ...
            $data['restaurant_id'] =auth('restaurant')->id();
    ...
    public function updateStatus(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => __('label.fail_proccess'),
            ]);
        }
